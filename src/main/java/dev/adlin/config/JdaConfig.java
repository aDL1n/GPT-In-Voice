...
import dev.adlin.config.properties.DiscordProperties;
...
public class JdaConfig {
    ...
    public Guild getGuild() {
        Assert.notNull(discordProperties.getGuildId(),  "Guild Id cannot be null");
        return getJda().getGuildById(discordProperties.getGuildId());
    }
}
